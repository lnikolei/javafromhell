...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("verifier:  " + "1.6180339887498948482045868343656" + "    31 Dezimalstellen von Wikipedia");
		...
		MathContext mc = new MathContext(51, RoundingMode.HALF_UP);
		System.out.println(mc);

		System.out.println("Nun berechnen wir unser Ergebnis mit einer Präzision von 50 Nachkommastellen:");
		System.out.println("pre-result:  " + a.add(c).divide(b, mc).toString() + "  nach 50 Dezimalstellen gerundet");

		System.out.println(
				"Die Aufgabe fragt nun aber nur nach 30 Nachkommastellen. Also erstellen wir einen weiteren MathContext:");
		MathContext mc2 = new MathContext(31, RoundingMode.HALF_UP);
		System.out.println(mc2);

		System.out.println(
				"Nun berechnen wir unser tatsächliches Ergebnis, welches nach 30 Nachkommastellen aufgerundet wird, weshalb unser Ergebnis an der letzten Stelle von unserem Verifikationsmittel abweicht:");
		System.out.println("result:    " + a.add(c).divide(b, mc2).toString() + "  nach 30 Dezimalstellen gerundet");
		System.out.println("verifier:  " + "1.6180339887498948482045868343656" + "    31 Dezimalstellen von Wikipedia");
		System.out.println(
